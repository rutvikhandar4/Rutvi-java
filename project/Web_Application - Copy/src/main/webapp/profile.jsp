                          ...
                          <div class="col-md-8 ct-form">
                              ...
                              <form class="contact-form" action="UserController" method="post">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="email" class="form-control" name="email" id="cf_email" value="<%=u1.getEmail()%>" readonly="readonly">
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea class="form-control" name="address" id="cf_message"><%=u1.getAddress() %></textarea>
                                  </div>
